    ...
    given("Un AG") {
        ...
        on("Rna") {
            ...
            it("se debe entrenar y devolver un valor posible con un Array de double con un tamaño de datos salida"){
                var rna: Rna = Rna(map, true)
                val random: Random = Random()
                val datosEntrada: DoubleArray = DoubleArray(rna.datosEntrada,{Math.abs(random.nextDouble()*100)})
                val datosSalida: DoubleArray = DoubleArray(rna.datosDeSalida,{Math.abs(random.nextDouble()*100)})
                val datosEntrada1: DoubleArray = DoubleArray(rna.datosEntrada,{Math.abs(random.nextDouble()*100)})
                val datosSalida1: DoubleArray = DoubleArray(rna.datosDeSalida,{Math.abs(random.nextDouble()*100)})
                val datosEntrada2: DoubleArray = DoubleArray(rna.datosEntrada,{Math.abs(random.nextDouble()*100)})
                val datosSalida2: DoubleArray = DoubleArray(rna.datosDeSalida,{Math.abs(random.nextDouble()*100)})
                val datosEntrada3: DoubleArray = DoubleArray(rna.datosEntrada,{Math.abs(random.nextDouble()*100)})
                val datosSalida3: DoubleArray = DoubleArray(rna.datosDeSalida,{Math.abs(random.nextDouble()*100)})
                rna.agregarValorDeEntrenamiento(datosEntrada,datosSalida)
                rna.agregarValorDeEntrenamiento(datosEntrada1,datosSalida1)
                rna.agregarValorDeEntrenamiento(datosEntrada2,datosSalida2)
                rna.agregarValorDeEntrenamiento(datosEntrada3,datosSalida3)
